...
class App extends Component {
  ...
  handleAddList(s) {
    ...
    var itms = Object.assign({}, this.state.items);
    itms[s]= [];
      this.setState({lists:this.state.lists.concat(s), items: itms });
   ...
   */
  handleAddItem(s,n) {
    var dup = Object.assign({}, this.state.items);

    dup[n] = dup[n].concat({'name' : s});
     console.log(dup[n]);
    this.setState({items : dup});
  }
